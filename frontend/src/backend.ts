...
import type { Category as _Category, NewProduct as _NewProduct, Product as _Product, UpdateProduct as _UpdateProduct, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: NewProduct): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, to_candid_NewProduct_n8(this._uploadFile, this._downloadFile, arg1));
    ...
    async deleteProduct(arg0: string): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: UpdateProduct): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(to_candid_UpdateProduct_n18(this._uploadFile, this._downloadFile, arg0));
                return from_candid_Product_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "watches" in value ? Category.watches : "electronics" in value ? Category.electronics : value;
}
...
function to_candid_UpdateProduct_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UpdateProduct): _UpdateProduct {
